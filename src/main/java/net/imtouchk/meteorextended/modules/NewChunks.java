...
/*
    ...
    CODE DERIVED FROM https://github.com/AntiCope/meteor-rejects/
*/
public class NewChunks extends Module {
    ...
    public NewChunks() {
        super(MeteorExtendedAddon.Companion.getCATEGORY(), "new-chunks", "Detects completely new chunks using certain traits of them");
    }

    public ChunkPos[] getNewChunks() {
        synchronized (newChunks) {
            return (ChunkPos[]) newChunks.toArray().clone();
        }
    }

    public ChunkPos[] getOldChunks() {
        synchronized (oldChunks) {
            return (ChunkPos[]) oldChunks.toArray().clone();
        }
    }
